...
<div id="carrito">
	...
	<h1><fmt:message key="carrito" bundle="${traducciones}"></fmt:message></h1>
		...
		<c:when test="${carrito!=null}">
			<c:forEach items="${carrito.getLineas()}" var="lineas">
				<div class="lineacarrito">
					...
					<span><fmt:message key="precio" bundle="${traducciones}"/>:${lineas.getContenido().getPrecio()} $</span> <span>- ${lineas.getContenido().getPrecioDescontado()} $</span>
					<a class="enlace"
